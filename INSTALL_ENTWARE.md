...
Удаление панели не является способом удалить или сбросить Mihomo-конфигурацию. Перед изменениями создайте резервную копию в разделе «Конфигурация» DHQClash Router.
